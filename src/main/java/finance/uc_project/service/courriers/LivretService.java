...
public class LivretService {
    ...
    public Livret createLivretPersonalise(String titre, byte[] contenue, String typeDeContenue, String livretType, String userId, String typeDocument) {
        ...
        livret.setTypeDocument(typeDocument);
